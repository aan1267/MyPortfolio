...
function Certificate() {
  return (
    <div className="flex justify-center items-center flex-col my-[120px] max-w-[1200px]  mx-auto px-10">
      <div className="max-w-[800px] w-full">
        <img src={certificate} alt="certificate" className="sm:w-[500px] xs:w-[600px] lg:w-[900px] rounded-[20px] mx-auto" />
      </div>
      <div className="w-full">
        <div className="flex justify-between  items-center  text-[#16f2b3]  sm:max-w-[500px] md:max-w-[900px] mt-6 mx-auto">
          <h1 className="lg:text-2xl  sm:text-xl font-black">What I learn....</h1>
        ...
        {learnings.map((learning) => (
            ...
            <div className="flex mb-2 gap-2  xs:text-sm lg:text-xl text-xl items-center">
              <img
                ...
                alt=".."
              />
              <p className="text-white xs:text-[13px] md:text-xl">
                {learning}
              </p>
