  ...
  return (
    <>
      <motion.div 
        ...
        viewport={{ once: true }} 
        variants={variants}
        className="w-full p-8 min-h-[250px] mt-[200px] mx-auto bg-[#110016]" id="about">
        <h1 className="text-center  text-white text-xl border-b border-yellow-100 max-w-40 mx-auto mb-8">A Bit About Me</h1>
        <div className="flex mb-2 gap-2  xs:text-sm lg:text-xl text-xl" variants={variants}>
          <img
        ...
        <h1 className="text-center text-gray-200 lg:text-lg xs:text-[11px]">"I believe in learning something new every day to grow as a programmer."</h1>
        <div>
           ...
           {activesection === "Education" && open === "Education" && (
              <div className="flex gap-4 flex-wrap">
               ...
               <h1 className="md:text-lg xs:text-sm bg-[#110016] rounded-lg py-5 md:px-6 xs:px-2 h-[180px] xs:h-[90px] md:h-[150px]"><span className="text-green-300">2022-2025</span><br/>
                Bachelor Degree (BCA)</h1>
                </div>
                 <div key={"skills"} className="text-white green-pink-gradiant mt-5 rounded-lg w-[250px] p-[1px]">
                <h1 className="md:text-lg xs:text-sm bg-[#110016] rounded-lg py-5 md:px-6 xs:px-2 h-[180px] xs:h-[90px] md:h-[150px]"><span className="text-green-300">2020-2022</span><br/>
           ...
           {activesection === "skills" && open === "skills" && (
             <div key={"skills"} className="max-width-[20px] text-white">
                 <div className="flex gap-4 flex-wrap">
                <div key={"skills"} className="text-white green-pink-gradiant mt-5 rounded-lg w-[250px] p-[1px]">
               <h1 className="md:text-lg xs:text-sm  bg-[#110016] rounded-lg py-5 md:px-6 xs:px-2  md:h-[150px] xs:h-[90px]"><span className="text-green-300">2022-2025</span><br/>
                 Web Developer</h1>
                </div>
                </div>
                </div>
