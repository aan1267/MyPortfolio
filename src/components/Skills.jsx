...
function Skills() {
  ...
  return (
    ...
    className="text-center text-white font-black mt-[150px] lg:mt-[200px]"
  >
     <h1 className="md:text-[60px] sm:text-[10px] xs:text-[20px] lg:text-[40px] font-black">Skills</h1>
     <Marquee
      gradient={false}
      speed={200}
      pauseOnHover={true}
    ...
    >
  {skills.map( (skill) => (
     <div className="border-t border-b py-20 xs:py-8 px-6 mt-3  border-[#23213b] lg:max-w-full md:max-w-50   mb-10  flex justify-center">
